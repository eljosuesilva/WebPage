                    ...
                    <div className="max-w-xl">
                        ...
                        <div className="flex gap-4">
                            <Link href="https://www.mapsgpt.es" target="_blank">
                                <Button size="lg" className="bg-purple-600 hover:bg-purple-700 shadow-lg border-none text-white">Start Exploring</Button>
                            </Link>
                        </div>
                    </div>
                </section>
                ...
                <section id="gpt-how" className="min-h-screen flex flex-col justify-center p-8 md:p-16 pointer-events-auto bg-gradient-to-r from-white/95 to-transparent md:from-white/90">
                    <div className="max-w-xl">
                        ...
                        <div className="bg-purple-50 p-6 rounded-xl border border-purple-100 mb-6">
                            <h4 className="font-bold text-purple-900 mb-2">1. Type your wish</h4>
                            <p className="text-gray-600 italic">&quot;Plan a 3-day trip to Paris for a couple who likes art and cheap food.&quot;</p>
                        </div>

                        <div className="bg-purple-50 p-6 rounded-xl border border-purple-100 mb-6">
                            <h4 className="font-bold text-purple-900 mb-2">2. Explore the Map</h4>
                        ...
                        <div className="bg-purple-50 p-6 rounded-xl border border-purple-100 mb-6">
                            <h4 className="font-bold text-purple-900 mb-2">3. Refine and Travel</h4>
